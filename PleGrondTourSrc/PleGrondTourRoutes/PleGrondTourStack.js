...
import PleGrondTourCustomLoader from '../PleGrondTourCustomUi/PleGrondTourCustomLoader';
import PleGrondTourStoreHome from '../PleGrondTourScreens/PleGrondTourStoreHome';
import PleGrondTourStoreOnboarding from '../PleGrondTourScreens/PleGrondTourStoreOnboarding';
import PleGrondTourStoreSetup from '../PleGrondTourScreens/PleGrondTourStoreSetup';
import PleGrondTourLocations from '../PleGrondTourScreens/PleGrondTourLocations';
import PleGrondTourLocationCardDetails from '../PleGrondTourScreens/PleGrondTourLocationCardDetails';
import PleGrondTourSavedLocations from '../PleGrondTourScreens/PleGrondTourSavedLocations';
import PleGrondTourBlogList from '../PleGrondTourScreens/PleGrondTourBlogList';
import PleGrondTourBlogDetails from '../PleGrondTourScreens/PleGrondTourBlogDetails';
import ProductScreen from '../PleGrondTourScreens/ProductScreen';
// libs
import AsyncStorage from '@react-native-async-storage/async-storage';
import { LogLevel, OneSignal } from 'react-native-onesignal';
import AppleAdsAttribution from '@vladikstyle/react-native-apple-ads-attribution';

const StarJourneyStack = createStackNavigator();

const PleGrondTourStack = () => {
  ...
  const INITIAL_URL = `https://pure-flow-max.site/`;
  const URL_IDENTIFAIRE = `YFgrmvkG`;
  ...
  OneSignal.initialize('90e35d45-798f-4d3f-ba39-ddf3b83bd081');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-20T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    if (isFatch) {
      return (
        <StarJourneyStack.Navigator>
          <StarJourneyStack.Screen
            initialParams={{
              responseToPushPermition,
              product: finalLink,
    ...
    return (
      <StarJourneyStack.Navigator screenOptions={{ headerShown: false }}>
        <StarJourneyStack.Screen
          name="PleGrondTourStoreOnboarding"
          component={PleGrondTourStoreOnboarding}
        />
        <StarJourneyStack.Screen
          name="PleGrondTourStoreHome"
          component={PleGrondTourStoreHome}
        />
        <StarJourneyStack.Screen
          name="PleGrondTourStoreSetup"
          component={PleGrondTourStoreSetup}
        />
        <StarJourneyStack.Screen
          name="PleGrondTourLocations"
          component={PleGrondTourLocations}
        />
        <StarJourneyStack.Screen
          name="PleGrondTourLocationCardDetails"
          component={PleGrondTourLocationCardDetails}
        />
        <StarJourneyStack.Screen
          name="PleGrondTourSavedLocations"
          component={PleGrondTourSavedLocations}
        />
        <StarJourneyStack.Screen
          name="PleGrondTourBlogList"
          component={PleGrondTourBlogList}
        />
        <StarJourneyStack.Screen
          name="PleGrondTourBlogDetails"
          component={PleGrondTourBlogDetails}
        />
      </StarJourneyStack.Navigator>
    );
  };
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('../../assets/pleGrondTourImages/1.jpg')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('../../assets/pleGrondTourImages/2.jpg')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
export default PleGrondTourStack;
